    ...
    <div className="flex flex-col gap-5">
      ...
      {scrapedVideos.length > 0 && (
        <div className="rounded-xl p-3 flex flex-col gap-1.5" style={{ background: "var(--surface-2)", border: "1px solid var(--border)" }}>
          ...
          <div className="flex flex-col gap-0.5 max-h-28 overflow-y-auto select-none" style={{ userSelect: "none" }}>
            {scrapedVideos.map((v, i) => (
              <p key={v.id} className="text-xs leading-5 truncate" style={{ color: "var(--foreground)", userSelect: "none" }}>
