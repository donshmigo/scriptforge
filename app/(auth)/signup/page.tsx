...
export default function SignupPage() {
  ...
  const strengthColor = ["", "var(--red)", "#f59e0b", "#3b82f6", "var(--green)"][passwordStrength];
        ...
        >
          <div
            style={{
              ...
              height: "64px",
              borderRadius: "50%",
              background: "rgba(92,252,160,0.1)",
              border: "1px solid rgba(92,252,160,0.3)",
              display: "flex",
              alignItems: "center",
              justifyContent: "center",
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Start writing scripts that actually hold attention
          </p>
